...
userRouter.get("/all-users",adminJwtVerify, userController.getAllUsersController)
userRouter.get("/single-user/:id",userJwtVerify,adminJwtVerify, userController.getSingleController)
userRouter.put("/update/:id",userJwtVerify,adminJwtVerify, userController.updateUserController)
